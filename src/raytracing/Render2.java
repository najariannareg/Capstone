...
public class Render2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Color blue = new Color(0.25f, 0.25f, 0.75f);
        ...
        Material walls = new Material(MaterialType.LAMBERTIAN, grey, 30);
        Material floorMat = new Material(MaterialType.LAMBERTIAN, greyDark, 30);
        Material sphereMat1 = new Material(MaterialType.LAMBERTIAN, green,30);
        Material sphereMat2 = new Material(MaterialType.LAMBERTIAN, red,30);
        Material sphereMat3 = new Material(MaterialType.LAMBERTIAN, blue,30);
        ...
        LightDistant light3 = new LightDistant(
                new Vec3(1, -1, -0.6f),
                0.5f, 30f, 30f,
                white
        );
